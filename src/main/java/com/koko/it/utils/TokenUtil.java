...
import com.koko.it.entity.TokenHeader;
import com.koko.it.entity.TokenPlayload;
...
public class TokenUtil {
    ...
    private static String tokenHeaderBase64() throws Exception {
        ...
        String headerJson = new Gson().toJson(tokenHeader);
    ...
    private static <T> String tokenPayloadBase64(TokenPlayload<T> tokenPlayload) throws Exception {
        ...
        String headerJson =new Gson().toJson(tokenPlayload);
    ...
    public static <T> boolean verifyJWT(String jwtBase64) throws Exception {
        ...
        TokenPlayload tTokenPlayload = new Gson().fromJson(new String(Base64Util.decryptBASE64(jwts[1])),TokenPlayload.class);
